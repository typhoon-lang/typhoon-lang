...
/* Poll driver once from scheduler idle path. */
 ...
 */
int64_t ty_io_read(void* driver, SlabArena* arena, void* coro, ty_fd_t fd, uint8_t* buf,
  size_t len);
int64_t ty_io_write(void* driver, SlabArena* arena, void* coro, ty_fd_t fd,
